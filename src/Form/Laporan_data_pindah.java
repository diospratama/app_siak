...
public class Laporan_data_pindah extends javax.swing.JFrame {
    JasperReport JasRep;
            ...
            JOptionPane.showMessageDialog(null,"Filed belum dilengkapi");
                ...
                try {
                 ...
                 try{
                  ...
                  java.io.File report1=new java.io.File(currentDir+"/src/report/Laporan_data_pindah.jrxml");
